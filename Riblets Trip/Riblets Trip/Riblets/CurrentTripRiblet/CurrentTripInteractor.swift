...
enum CurrentTripUserAction {
   
}

class CurrentTripInteractor : ViewableInteractor<CurrentTripRoutable, CurrentTripUserAction, CurrentTripPresenter> {
